...
example_valid_polya_table$group <- factor(example_valid_polya_table$group)
example_valid_polya_table$sample_name <- factor(example_valid_polya_table$sample_name)
example_valid_polya_table$qc_tag <- factor(example_valid_polya_table$qc_tag)
...
example_valid_polya_table_3levels$group <- factor(example_valid_polya_table_3levels$group)
example_valid_polya_table_3levels$sample_name <- factor(example_valid_polya_table_3levels$sample_name)
example_valid_polya_table_3levels$qc_tag <- factor(example_valid_polya_table_3levels$qc_tag)
